...
#define UL_SYSTEM_SF_I_PRIVATE_SERVICE_INTERFACE_INFO(C, H) \
    ...
    AMS_SF_METHOD_INFO(C, H, 1, Result, PopMessageContext, (ams::sf::Out<::ul::smi::MenuMessageContext> out_msg), (out_msg))
...
namespace ul::system::sf {
    ...
    class PrivateService {
        ...
        public:
            ...
            ams::Result PopMessageContext(ams::sf::Out<smi::MenuMessageContext> out_msg);
    };
